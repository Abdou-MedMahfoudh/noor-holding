// i18n.js - Internationalization Script for Noor Holding Website
 ...
 class I18nManager {
   ...
   tn(key) {
     ...
     const keys = key.split(".");
     let value = this.newsTranslations[this.currentLanguage]; // ✅ use this
   ...
   applyNewsTranslations() {
     ...
     Object.keys(articles).forEach((id) => {
       ...
       this.updateElement(
         `[data-i18n="articles.${id}.title"]`,
         this.tn(`articles.${id}.title`)
       );
       this.updateElement(
         `[data-i18n="articles.${id}.description"]`,
         this.tn(`articles.${id}.description`)
       );
       this.updateElement(
         `[data-i18n="articles.${id}.author"]`,
         this.tn(`articles.${id}.author`)
       );
       this.updateElement(
         `[data-i18n="articles.${id}.category"]`,
         this.tn(`articles.${id}.category`)
       );
       this.updateElement(
         `[data-i18n="articles.${id}.content"]`,
         this.tn(`articles.${id}.content`)
       );
     });
   }
   ...
   applyTranslations() {
     ...
     this.updateElement(
       '[data-i18n="ceo.entities.ecocharge"]',
       this.t("ceoMessage.entities.ecocharge")
     );
     this.updateElement(
       '[data-i18n="ceo.entities.agro"]',
       this.t("ceoMessage.entities.agro")
     );
     this.updateElement(
     ...
     // News Section
     this.updateElement(
       '[data-i18n="news.hero.main"]',
       this.t("news.hero.main")
     );
     this.updateElement(
       '[data-i18n="news.hero.desc"]',
       this.t("news.hero.desc")
     );
     this.updateElement(
       '[data-i18n="news.hero.uptitle"]',
       this.t("news.hero.uptitle")
     );

     this.updateElement('[data-i18n="news.title"]', this.t("news.title"));
     this.updateElement('[data-i18n="news.viewAll"]', this.t("news.viewAll"));
     this.updateElement('[data-i18n="news.readMore"]', this.t("news.readMore"));
     this.updateElement(
       '[data-i18n="news.backToNews"]',
       this.t("news.backToNews")
     );
     this.updateElement(
       '[data-i18n="news.shareArticle"]',
       this.t("news.shareArticle")
     );
     this.updateElement(
       '[data-i18n="news.noArticles"]',
       this.t("news.noArticles")
     );
     this.updateElement(
       '[data-i18n="news.loadingArticles"]',
       this.t("news.loadingArticles")
     );
     this.updatePlaceholder(
       '[data-i18n-placeholder="news.searchPlaceholder"]',
       this.t("news.searchPlaceholder")
     );

     this.updateElement(
       '[data-i18n="news.showingResults"]',
       this.t("news.showingResults")
     );
     this.updateElement('[data-i18n="news.article"]', this.t("news.article"));
     this.updateElement(
       '[data-i18n="news.showingFiltered"]',
       this.t("news.showingFiltered")
     );
     this.updateElement(
       '[data-i18n="news.articleNotFound"]',
       this.t("news.articleNotFound")
     );
     this.updateElement(
       '[data-i18n="news.unableToLoad"]',
       this.t("news.unableToLoad")
     );

     // EcoCharge Africa
     this.updateElement(
       '[data-i18n="subsidiaries.companies.ecocharge.name"]',
       this.t("subsidiaries.companies.ecocharge.name")
     );
     this.updateElement(
       '[data-i18n="subsidiaries.companies.ecocharge.description"]',
       this.t("subsidiaries.companies.ecocharge.description")
     );
     this.updateElement(
       '[data-i18n="subsidiaries.companies.ecocharge.services.0"]',
       this.t("subsidiaries.companies.ecocharge.services.0")
     );
     this.updateElement(
       '[data-i18n="subsidiaries.companies.ecocharge.services.1"]',
       this.t("subsidiaries.companies.ecocharge.services.1")
     );
     this.updateElement(
       '[data-i18n="subsidiaries.companies.ecocharge.services.2"]',
       this.t("subsidiaries.companies.ecocharge.services.2")
     );
     this.updateElement(
       '[data-i18n="subsidiaries.companies.ecocharge.services.3"]',
       this.t("subsidiaries.companies.ecocharge.services.3")
     );
     this.updateElement(
       '[data-i18n="subsidiaries.companies.ecocharge.services.4"]',
       this.t("subsidiaries.companies.ecocharge.services.4")
     );

     // Agro (CASA)
     this.updateElement(
       '[data-i18n="subsidiaries.companies.agro.name"]',
       this.t("subsidiaries.companies.agro.name")
     );
     this.updateElement(
       '[data-i18n="subsidiaries.companies.agro.description"]',
       this.t("subsidiaries.companies.agro.description")
     );
     this.updateElement(
       '[data-i18n="subsidiaries.companies.agro.services.0"]',
       this.t("subsidiaries.companies.agro.services.0")
     );
     this.updateElement(
       '[data-i18n="subsidiaries.companies.agro.services.1"]',
       this.t("subsidiaries.companies.agro.services.1")
     );
     this.updateElement(
       '[data-i18n="subsidiaries.companies.agro.services.2"]',
       this.t("subsidiaries.companies.agro.services.2")
     );
     this.updateElement(
   ...
   createLanguageSwitcher() {
    ...
    `;
     ...
     menu.className =
       "hidden absolute left-0 mt-2 w-30 bg-black/20 backdrop-blur-sm rounded-lg shadow-lg border border-white/10 z-50 overflow-hidden";
     menu.id = "mobile-lang-menu";

     this.supportedLanguages.forEach((lang, index) => {
       const item = document.createElement("button");
       item.className = `group flex items-center w-full text-left px-3 py-2 text-white hover:bg-white/10 transition-all duration-300 space-x-2 text-md ${
   ...
   createMobileLanguageSwitcher() {
     const hiddenPages = ["Allnews.html", "news.html", "about.html"];
     ...
     switcherContainer.className = "flex md:hidden relative";
